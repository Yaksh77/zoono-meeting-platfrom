...
import meet_image from "../../../public/images/meet_image.jpg";
    ...
    <div className="flex min-h-screen bg-linear-to-r from-blue-100 to-purple-200 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="flex flex-col justify-center w-full p-8 lg:w-1/2">
        <div className="max-w-md mx-auto">
          <h1 className="mb-4 text-4xl font-bold">Welcome, to Zoono Meet</h1>
          <p className="mb-8 text-gray-600 dark:to-gray-100">
            Connect with your team anytime and anywhere. Get started for free.
          </p>
